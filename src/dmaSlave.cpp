...
void setup()
{
    ...
    receiveBuf1 = slave.allocDMABuffer(50000);
    receiveBuf2 = slave.allocDMABuffer(50000);
    imageBuf = receiveBuf1;
    ...
    xTaskCreatePinnedToCore(slaveTask, "SlaveBoi", 32768, NULL, 1, NULL, 1);
